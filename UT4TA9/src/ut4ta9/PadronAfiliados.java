...
public class PadronAfiliados implements IPadronAfiliados {
    ...
    public ILista<Afiliado> limpiar() {
        ...
        while (auxAfiliado != null) {
            ...
            if (contadorConsultas > 1) {
                eliminados.insertar(new Nodo(consultaAfiliado.getEtiqueta(), consultaAfiliado.getDato()));
    ...
    public ILista<Afiliado> limpiar2() {
        ...
        while (auxAfiliado != null) {
            ...
            System.out.println(auxAfiliado.getDato().getConsultasAnotadas().cantElementos());;
            auxAfiliado = auxAfiliado.getSiguiente();
        }
        return eliminados;
    }
